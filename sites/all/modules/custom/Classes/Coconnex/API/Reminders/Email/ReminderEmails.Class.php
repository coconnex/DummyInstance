<?
namespace Coconnex\API\Reminders\Email;
...
require_once dirname(dirname(dirname(dirname(__FILE__))))."/Utils/Email/CNXMail.Class.php";
require_once dirname(dirname(dirname(dirname(__FILE__))))."/Utils/Handlers/TemplateHandler.Class.php";

class ReminderEmails extends CNXMail {
    ...
    protected function initialise(){
        if($this->type != ""){
            ...
            while($row = $obj_config::getRow($rs)){
                ...
                if(isset($this->tokens['SUBJECT']) || $this->tokens['SUBJECT'] != ""){
                    $this->subject = $this->tokens['SUBJECT'];
                }else{
