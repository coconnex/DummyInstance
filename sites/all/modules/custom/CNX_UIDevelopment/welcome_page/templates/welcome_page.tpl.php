...
<div class="wlecome-page">
    <div class="row m-0">
        ...
        <div class="col-lg-8 col-md-12 information-sec">
            <div class="header">
                <h5 class="m-0 pt-3 pt-lg-0">Welcome to Top Drawer 2025 self service stand booking opportunity!</h5>
            </div>
            <div class="description">
                <div class="company-name">This opportunity applies to <strong>[Company Name]</strong></div>
                <div class="info">
                    <p class="m-0">
                        On behalf of the entire Top Drawer team, I'd like to thank you for your continued support. We're working hard to ensure we deliver an enjoyable and profitable event for all our exhibitors and we wanted to take this opportunity to wish you every success onsite at the show.
                    </p>
                </div>
            </div>
