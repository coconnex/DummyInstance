...
// */
function ezone_anonymous_preprocess_user_login(&$variables)
{
 ...
 */
function ezone_anonymous_theme(&$existing, $type, $theme, $path)
{
...
function ezone_anonymous_status_messages($display = NULL)
{
