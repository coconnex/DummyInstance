...
<div id="Forgotpassword" class="forgotPassword_center">
...
<div id="login-logo" style="background-image: url('<?php echo $logopath;?>');"></div>
	<div class="fw-bold fs-4 text-center pt-3 pb-3 login-title" >Forgot Your Password</div>
...
<script>
	...
	function setPageHeight(){
		var loginElem = document.getElementById("Forgotpassword");
