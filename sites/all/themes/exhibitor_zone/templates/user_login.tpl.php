	...
	<div id="loginbox" class="login_center">
		...
		<div class="fw-bold fs-5 text-center pt-3 login-title"><?php echo variable_get('site_name','');?></div>
		...
		<div class="login_buttons">
				...
				<div class="float-end"><a href="/participation/confirm"><u>Create a New Account</u></a></div>
		</div>
	</div>
