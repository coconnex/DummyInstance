...
use Coconnex\Utils\Handlers\ProcessingPopupHandler;

global $user;
$cache_control_string = '?' . substr(variable_get('css_js_query_string', '0'), 0, 1);
$args = arg();
?>
...
<head>
  ...
  <?php AssetHandler::render_assets(); ?>
</head>

<body class="<?php print $classes; ?><?php echo in_array('anonymous user', $user->roles) ? " body-bg" : ""; ?>">
    ...
    <div id="page">
      <div id="header" class="sticky-top">
        <div class="section clearfix">
          ...
          <?php if (!in_array('anonymous user', $user->roles)) print $header;
          ?>
      ...
      <div id="main-wrapper">
        <div id="main" class="clearfix<?php if ($primary_links || $navigation) {
      ...
      <?php if (($footer || $footer_message || $secondary_links) && (strtolower(implode(",", $args)) !== 'floorplan')) : ?>
        <div id="footer">
          <div class="section">

            <?php print theme(
              array('links__system_secondary_menu', 'links'),
              $secondary_links,
              array(
                'id' => 'secondary-menu',
                'class' => 'links clearfix',
  ...
  <?php ProcessingPopupHandler::render(); ?>

  <?php AssetHandler::render_assets(true); ?>
